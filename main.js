...
// Windows. Set it to the packaged appId (build.appId in package.json) so the
// notifications wire up to the installed Start-menu shortcut. No-op on
// macOS/Linux. Called before app `ready` per Electron's guidance.
